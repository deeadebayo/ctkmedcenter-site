...
$(window).scroll(function () {
  //function here to change the behavior of the navbar when you scroll past a certain length
  "use strict";
...
$(function () {
  ...
  eDisplayMoment.innerHTML = NowMoment.format(
...
(function () {
  ...
  var today = new Date(),
    ...
    thisYear = document.getElementById("this-year");
